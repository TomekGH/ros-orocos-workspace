...
bool registerROSServiceProxies() {
  ...
  //success = success && register_service_factory(new ROSServiceProxyFactory<std_srvs::Empty>("std_srvs/Empty"));
    success = success && register_service_factory(new ROSServiceProxyFactory<nav_msgs::GetMap>("nav_msgs/GetMap"));
  success = success && register_service_factory(new ROSServiceProxyFactory<nav_msgs::GetPlan>("nav_msgs/GetPlan"));
...
extern "C" {
  ...
  std::string getRTTPluginName () { return "rtt_nav_msgs_ros_service_proxies"; }
