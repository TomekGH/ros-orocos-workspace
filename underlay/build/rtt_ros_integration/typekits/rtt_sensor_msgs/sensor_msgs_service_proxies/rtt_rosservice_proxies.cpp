...
bool registerROSServiceProxies() {
  ...
  //success = success && register_service_factory(new ROSServiceProxyFactory<std_srvs::Empty>("std_srvs/Empty"));
    success = success && register_service_factory(new ROSServiceProxyFactory<sensor_msgs::SetCameraInfo>("sensor_msgs/SetCameraInfo"));
...
extern "C" {
  ...
  std::string getRTTPluginName () { return "rtt_sensor_msgs_ros_service_proxies"; }
