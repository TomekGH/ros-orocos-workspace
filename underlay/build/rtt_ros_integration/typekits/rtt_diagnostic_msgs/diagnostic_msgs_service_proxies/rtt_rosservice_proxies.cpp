...
bool registerROSServiceProxies() {
  ...
  //success = success && register_service_factory(new ROSServiceProxyFactory<std_srvs::Empty>("std_srvs/Empty"));
    success = success && register_service_factory(new ROSServiceProxyFactory<diagnostic_msgs::SelfTest>("diagnostic_msgs/SelfTest"));
...
extern "C" {
  ...
  std::string getRTTPluginName () { return "rtt_diagnostic_msgs_ros_service_proxies"; }
