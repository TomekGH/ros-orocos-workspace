...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rtt_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tpokorsk/ros-orocos-workspace/underlay/install/${idir}'.  Ask the maintainer 'Orocos Developers <orocos-dev@lists.mech.kuleuven.be>' to fix it.")
    endif()
