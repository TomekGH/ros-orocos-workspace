...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'sarkofag_regulator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tpokorsk/ros-orocos-workspace/sarkofag/src/sarkofag_regulator/${idir}'.  Ask the maintainer 'Tomasz Pokorski <tomek.pokorski@gmail.com>' to fix it.")
    endif()
